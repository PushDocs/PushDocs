...
Макеты показывают предлагаемое расположение разделов и элементов интерфейса. Приложение ещё не реализовано. Названия участников, содержимое документов и состояния проверок приведены для примера, даже если используются знакомые номера MR и pipeline.
...
![Участники](06-members.png)

## Что ещё нужно уточнить

Логотип, размеры и некоторые иконки различаются между концептами. При разработке их нужно привести к единой системе компонентов Base UI. Лица на картинках сгенерированы и не изображают настоящих участников проекта.
